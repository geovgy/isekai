...
contract ShieldedPoolBranch is EIP712, Ownable {
    ...
    bytes32 private constant SIGNER_DELEGATION_TYPEHASH = keccak256("SignerDelegation(uint64 chainId,address owner,address delegate,uint256 startTime,uint256 endTime,address token,uint256 tokenId,uint256 amount,uint8 amountType,uint256 maxNonce,uint256 timeInterval,uint8 transferType)");
